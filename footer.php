  ...
  <div class="container">
	<div class="row">
	  <div class="col l6 m6 s12">
		<h5 class="white-text">Proposez!</h5>
		<p class="grey-text text-lighten-4">Vous avez une recette et souhaitez la faire apparaître sur <i>La Cuisine Etudiante</i> ? <a class="grey-text text-lighten-3" href="mailto:guillaume.perouffe@centrale-marseille.fr">Ecrivez-nous!</a></p>
	  </div>
